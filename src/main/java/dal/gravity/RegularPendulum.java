...
public class RegularPendulum extends AbstractPendulum {
     ...
     */
    public RegularPendulum (double inLength, double inMass, double inTheta0, GravityModel grvModel, double inDelta, double inDiss) {
	super (inLength, inMass, inTheta0, grvModel);
	delta=inDelta;
	dissipation = inDiss;
	lastVel = 0;
    ...
    public RegularPendulum (double inLength, double inMass, double inTheta0, GravityModel grvModel,
		     double inDelta) {
	this (inLength, inMass, inTheta0, grvModel, inDelta, 0);
    }
